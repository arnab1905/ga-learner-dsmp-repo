...
print(loan_approved_se) #[56 rows x 12 columns]
loan_approved_nse = banks[(banks['Self_Employed']=='No') & (banks['Loan_Status']=='Y')]
print(loan_approved_nse) #[366 rows x 12 columns]
Loan_Status = 614
percentage_se = loan_approved_se.shape[0]*100/Loan_Status
print(percentage_se)
percentage_nse = loan_approved_nse.shape[0]*100/Loan_Status
